...
class manager{
  ...
  public function paiement($a) // Inserer la reservation dans la base de donnée
  {
    session_start();
  ...
  public function deconnexion() //Deconnexion PAR DESTRUCTION DE LA SESSION
  {
    session_start();
  ...
  public function inscription($a) // AJOUT UTILISATEUR DANS LA BASE DE DONNEE
  {
    session_start();
  ...
  public function modificationnomprenom($a) //MODIFIER LE PRENOM ET LE NOM
  {
    session_start();
    ...
    public function selectadmin($a){ //POUR AFFICHER LES UTILISATEURS POUR LES MODIFIER EN TANT QU'ADMIN
      ...
      public function selectfilm($a){ //POUR AFFICHER LES UTILISATEURS POUR LES MODIFIER EN TANT QU'ADMIN
        ...
        public function afficherfilm($a){ //POUR AFFICHER LES films choisis
          ...
          public function modificationpasswordadmin($a) //modifier le mot de passe en tant qu'admin
          {
            session_start();
          ...
          public function affichertoutreservation($a){ //POUR AFFICHER les reservation d'un utilisateur
            session_start();
            $_SESSION['stop'] = 6;
            $this->dbh = new bdd();
