		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="product-details">
					<h1 class="product-title">Le Le Petit Chaperon rouge</h1>
					<div class="product-meta">
						<ul class="list-inline">
							...
							<li class="list-inline-item"><i class="fa fa-location-arrow"></i> Location :<a href="">Paris</a></li>
						</ul>
					</div>
					...
					<div class="content mt-5 pt-5">
						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
								...
								<p>Le Petit Chaperon rouge est un conte de tradition orale d'origine française. Il s'agit d'un conte-type 333 selon la classification Aarne-Thompson</p>

								<iframe width="100%" height="400" src="https://fr.wikipedia.org/wiki/Le_Petit_Chaperon_rouge#/media/Fichier:Little_Red_Riding_Hood_-_J._W._Smith.jpg"
								 frameborder="0" allowfullscreen></iframe>
								<p></p>
								<p>Il est surtout connu par le biais de deux versions collectées,
                   retranscrites et interprétées par les moralistes Charles Perrault en France et les frères Grimm en Allemagne.
                    Depuis le milieu du XXe siècle,
                     il a fait l'objet de nombreux détournements opérant un retour aux sources de la tradition orale et populaire du conte.  </p>
