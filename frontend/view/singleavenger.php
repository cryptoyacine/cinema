		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="product-details">
					<h1 class="product-title">Avenger </h1>
            ...
            <?php } ?>
						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
								...
								<p>Avengers ou Les Avengers : Le film au Québec et au Nouveau-Brunswick (Marvel's The Avengers) est un film de super-héros américain écrit et réalisé par Joss Whedon, sorti en 2012. Il se base sur l'équipe de super-héros du même nom (Les Vengeurs en français) apparaissant dans le comic book publié par Marvel Comics. Sixième film de l'univers cinématographique Marvel, il clôt la phase I.</p>

								<iframe width="100%" height="400" src="https://fr.wikipedia.org/wiki/Avengers_(film)#/media/Fichier:Avengerslogo.png"
          ...
          <div class="widget price text-center">
					...
					<div class="widget user text-center">
						<img class="rounded-circle img-fluid mb-5 px-5" src="../../style/images/products/avenger.jpg" alt="">
						<h4><a href="">Avenger</a></h4>
