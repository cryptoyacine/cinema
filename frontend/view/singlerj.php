				...
				<div class="product-details">
					...
					<div class="product-meta">
						<ul class="list-inline">
							<li class="list-inline-item"><i class="fa fa-user-o"></i> De :<a href="">William Shakespeare</a></li>
							<li class="list-inline-item"><i class="fa fa-folder-open-o"></i> Categorie :<a href="">Tragédie</a></li>
							<li class="list-inline-item"><i class="fa fa-location-arrow"></i> Location :<a href="">Londre</a></li>
						</ul>
					</div>
					...
					<div class="content mt-5 pt-5">
						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
								...
								<p>Roméo et Juliette (Romeo and Juliet) est une tragédie de William Shakespeare.
                   Écrite vers le début de sa carrière, elle raconte l'histoire de deux jeunes gens,
                   Roméo Montaigu et Juliette Capulet,
                 qui s'aiment malgré la haine que se vouent leurs familles et connaissent un destin funeste. </p>

								<iframe width="100%" height="400" src="https://fr.wikipedia.org/wiki/Rom%C3%A9o_et_Juliette#/media/Fichier:Romeoandjuliet1597.jpg"
								 frameborder="0" allowfullscreen></iframe>
								<p></p>
								<p>La pièce s'inscrit dans une tradition d'histoires d'amour tragiques remontant à l'Antiquité. Son intrigue est issue d'un conte italien de Luigi da Porto
                  traduit en anglais et en vers par Arthur Brooke en 1536 sous le titre The Tragical History of Romeus and Juliet.
                   En 1582, William Painter (en) en propose une version en prose dans son Palace of Pleasure. Shakespeare emprunte aux deux,
                    mais il approfondit l'intrigue en développant les personnages secondaires, notamment Mercutio et le comte Pâris.
                     Probablement rédigée entre 1591 et 1595, la pièce est publiée pour la première fois en in-quarto en 1597.
                      Cette première édition, de mauvaise qualité, est supplantée par les éditions ultérieures qui respectent davantage le texte original de Shakespeare. </p>
			...
			<div class="col-md-4">
				<div class="sidebar">
					...
					<div class="widget user text-center">
						<img class="rounded-circle img-fluid mb-5 px-5" src="../../style/images/user/Shakespeare.jpg" alt="">
						<h4><a href="">William Shakespeare</a></h4>
						<p class="member-time">Date de publication originale : 1597</p>
