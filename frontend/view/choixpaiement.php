...
<PHP lang="en">
  <head>
    ...
    <?php
    if (isset($_SESSION['role'])){ //si on est connecté on peut acceder a la page
                ...
                <form action="../../backend/process/paiementfin.php" method= "post">
                  <fieldset class="p-4">
                    ...
                    <div class="form-group">
                      ...
                      function calcul(){
                        var prix = Number(document.getElementById("heuresI").value);      //permet le calcul automatique du prix (hors reduction)
    ...
    <?php $_SESSION["erreurcase"] = ''; }  else {header("Location: 404.php ");
