...
<head>
  ...
  if(isset($_SESSION["reservation"])) {  $res=$_SESSION["reservation"];}

}           // si on a la variable stop a 4 on recupere les valeurs pour voir les reservation sinon on va les chercher 
