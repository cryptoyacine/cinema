...
if (isset($_SESSION['stop']) and  $_SESSION['stop'] ==3) {    $res=$_SESSION["cd"];   }

else {
   $_SESSION['stop']=3; header("Location: ../../backend/process/affichertoutcd.php");
} ?>
<!-- SITE TITTLE -->
<meta charset="utf-8">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="block">
					<!-- Store First Letter -->
					<h5 class="store-letter">CD recherche</h5>
					<hr>
					<!-- Store Lists -->
					<div class="row">
						<!-- Store List 01 -->
...
if (isset($_SESSION["recherchecd"]) and $_SESSION["recherchecd"]!='') {

$rer =  $_SESSION["recherchecd"];
        ...
        ?>
              ...
              <form action="../../backend/process/affichercd.php" method= "post">
                <input type="text" name="CdNom" value=""/>
              </br>  </br>
...
<?php include('../include_frontends/plugins.php'); if (isset ($_SESSION["recherchecd"])){ $rer = $_SESSION["recherchecd"]='';}
?>
</body>
