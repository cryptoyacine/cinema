...
if (isset($_SESSION['stop']) and  $_SESSION['stop'] ==1) {    $res=$_SESSION["res"];    } // si on a la variable stop a 1 on recupere les valeurs pour voir les utilisateur

else {                                                                                        //sinon on va dans le process pour chercher puis recuperer les valeurs pour voir les utilisateurs
...
<section class="login py-5 border-top-1">
    <div class="container">
        ...
        foreach ($res as $value) {
          ...
          if ( $value["role"] ==1 ){$role = "oui";} else { //si le role est 1 l'utilisateur est marqué admin
            $role = "non";
          }
...
//gestion d'erreur des cases
            ...
            <div class="form-group">
              ...
              <?php //gestion d'erreur des cases
